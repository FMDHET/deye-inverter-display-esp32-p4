...
Am Gerät gemessen (9. September, Netzzähler absichtlich abgeschaltet): in der Minute Brücke wanderte die Akkuleistung von +56 W auf **−1284 W**, während die Emulation unverändert „0 Watt" meldete — der Deye hält also nicht, er driftet blind. Nach der Stummschaltung ging er auf Betriebszustand 3 (Alarm, Register 500), die Fehlercodes blieben leer, und die Akkuleistung beruhigte sich auf ±200 W: er regelt wieder gegen seinen eigenen Wandler. Als der Zähler zurückkam, sprang der Betriebszustand von selbst auf 2 (Normal) — **es ist nichts zu quittieren.**
